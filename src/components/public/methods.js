const tools = {
    ...
    handleEvent : {
        ...
        removeEvent(target, type, callback = function () {}) {
    ...
    listenerScrollEvent: {
        ...
        all(target, slideCallback) {
            ...
            if(window.navigator.userAgent.indexOf("Firefox")=== -1) {//不是firefox
                tools.handleEvent.addEvent(target, 'mousewheel', function (e)  {
                    slideCallback.call(target, e);
                });
            } else {//firefox
                tools.handleEvent.addEvent(target, 'DOMMouseScroll', function (e)  {
                    slideCallback.call(target, e)
                });
            }   
        },
